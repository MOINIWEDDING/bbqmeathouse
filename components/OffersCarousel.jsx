...
function demoOffers() {
  return [
    { id: 'o1', title: 'Costillas ahumadas todo el fin de semana', subtitle: 'Sábado y domingo, mientras haya en la parrilla.', image_url: 'https://images.unsplash.com/photo-1544025162-d76694265947?q=80&w=1200&auto=format&fit=crop', cta_text: 'Ver menú', cta_link: '/menu#ahumados' },
    { id: 'o2', title: 'Brisket 14 horas, recién salido del ahumador', subtitle: 'Cantidad limitada cada día.', image_url: 'https://images.unsplash.com/photo-1548899278-41c14dcddc69?q=80&w=1200&auto=format&fit=crop', cta_text: 'Ver menú', cta_link: '/menu#ahumados' },
  ];
}
